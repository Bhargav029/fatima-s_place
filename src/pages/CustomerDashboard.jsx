...
const CustomerDashboard = () => {
  ...
  // --- MOCK DATA ---
  const recentOrders = [
    { id: 'F9402', date: 'Today, 12:30 PM', items: '3 items', status: 'Preparing', price: '₹1,240', isCancelled: false },
    { id: 'F9102', date: 'Oct 12, 2025', items: '1 item', status: 'Cancelled', price: '₹450', isCancelled: true },
    { id: 'F8992', date: 'Sep 28, 2025', items: '4 items', status: 'Delivered', price: '₹1,120', isCancelled: false },
  ];

  const tableBookings = [
    { date: 'Sat, Nov 11', time: '8:00 PM', guests: 4, status: 'Confirmed' },
    { date: 'Sun, Nov 19', time: '1:30 PM', guests: 2, status: 'Pending' }
  ];

  const savedAddresses = [
    { type: 'Home', address: 'Apartment 402, Sea Breeze Heights, Dona Paula, Panaji, Goa 403004', isDefault: true },
    { type: 'Work', address: 'Innovation Hub, Patto Centre, Panaji, Goa 403001', isDefault: false },
    { type: 'Vacation', address: 'Villa 12, Coastal Palms, Morjim, Goa 403512', isDefault: false }
  ];

  const favoriteDishes = [
    { name: 'Authentic Prawn Balchão', price: '₹550', rating: 4.9, image: 'https://images.unsplash.com/photo-1544025162-836909b0e30b?auto=format&fit=crop&q=80&w=400' },
            ...
            <div className="animate-in fade-in duration-300">
              ...
              <div className="bg-[#6b75f2] rounded-2xl p-6 md:p-8 flex flex-col md:flex-row justify-between items-center gap-6 shadow-lg shadow-indigo-200 dark:shadow-none mb-8 text-white">
                <div className="flex items-center gap-4">
                  ...
                  <div><h2 className="text-xl font-black mb-1">Order #F2930 is being prepared!</h2><p className="text-indigo-100 text-sm">Estimated arrival in 24 minutes</p></div>
                </div>
                ...
                <div className="xl:col-span-2 space-y-8">
                  ...
                  <div className="grid sm:grid-cols-3 gap-4">
                    <div className="bg-white dark:bg-[#16171d] p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 flex items-center gap-4">
                      ...
                      <div><p className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-1">Total Orders</p><p className="text-2xl font-black text-gray-900 dark:text-white">24</p></div>
                    </div>
                    <div className="bg-white dark:bg-[#16171d] p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 flex items-center gap-4">
                      ...
                      <div><p className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-1">Loyalty Points</p><p className="text-2xl font-black text-gray-900 dark:text-white">1,450</p></div>
                    </div>
                    <div className="bg-white dark:bg-[#16171d] p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 flex items-center gap-4">
                      ...
                      <div><p className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-1">Reservations</p><p className="text-2xl font-black text-gray-900 dark:text-white">3</p></div>
                    </div>
                  </div>
                ...
                <div className="space-y-8">
                  ...
                  <div className="bg-white dark:bg-[#16171d] rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 dark:border-gray-800 overflow-hidden relative pb-6">
                    ...
                    <div className="relative z-10 flex flex-col items-center pt-10 px-6">
                      ...
                      <h3 className="text-xl font-black text-gray-900 dark:text-white text-center w-full truncate px-4">{user?.name || "Customer Name"}</h3>
